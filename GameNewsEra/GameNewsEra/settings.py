"""
Django settings for GameNewsEra project.
...
SECRET_KEY = 's##@4q2@3*n(tpjx8fqz571j*$jjojgm@696%gyk-+2&4m_+ov'
...
WSGI_APPLICATION = 'GameNewsEra.wsgi.application'
